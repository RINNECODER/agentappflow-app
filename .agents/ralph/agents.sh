...
AGENT_CODEX_CMD="/Applications/Codex.app/Contents/Resources/codex exec --yolo --skip-git-repo-check -"
AGENT_CODEX_INTERACTIVE_CMD="/Applications/Codex.app/Contents/Resources/codex --yolo --skip-git-repo-check {prompt}"
